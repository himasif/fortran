  ...
  <div class="scroll-sidebar">
    ...
    <nav class="sidebar-nav">
      <ul id="sidebarnav" class="p-t-30">
        ...
        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/admin/list" aria-expanded="false"><i class="mdi mdi-view-list"></i><span class="hide-menu">Daftar Peserta</span></a></li>
        ...
        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/admin/resign" aria-expanded="false"><i class="mdi mdi-exit-to-app"></i><span class="hide-menu">Resign</span></a></li>
      </ul>
    </nav>
